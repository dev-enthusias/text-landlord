...
import { getLandlordBills } from "@/api/services/bill";
...
export default async function BillsMgt() {
  ...
  const totalBills = bills.list?.length;
        ...
        <section className="px-5 lg:hidden">
          ...
          <div className="-mx-5 space-y-5">
            <div className="mb-3 flex items-center justify-between border-y border-gray-300 bg-white px-5 py-3">
              <p>Total tenants {totalBills}</p>
              <p>
                {totalBills > 0
                  ? `1-${totalBills} of ${totalBills} results`
                  : "No results"}
              </p>
            </div>
